window.onload = function() {
  ...
  let yeggleVideoFn = function() {
    ...
    yeggleVideo.parentElement.style.height =
      yeggleVideo.offsetHeight +
      parseFloat(yeggleVideo.style.marginTop.replace("px", "")) +
      "px";
  };
  let stockitVideoFn = function() {
    stockitVideo.style.marginTop = stockitVideo.offsetHeight * -37 / 400 + "px";
    stockitVideo.parentElement.style.height =
      stockitVideo.offsetHeight +
      parseFloat(stockitVideo.style.marginTop.replace("px", "")) +
      "px";
  };
  let jobsortVideoFn = function() {
    ...
    jobsortVideo.parentElement.style.height =
      jobsortVideo.offsetHeight +
      2 * parseFloat(jobsortVideo.style.marginTop.replace("px", "")) +
      "px";
  };
  let codeclubVideoFn = function() {
    codeclubVideo.style.marginTop =
      codeclubVideo.offsetHeight * -37 / 400 + "px";
    codeclubVideo.parentElement.style.height =
      codeclubVideo.offsetHeight +
      parseFloat(codeclubVideo.style.marginTop.replace("px", "")) +
      "px";
  };
